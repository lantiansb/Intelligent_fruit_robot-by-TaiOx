...
void Go()
{
    PWM_SetDuty(HT_MCTM0, TM_CH_2, 48000000/80000*57/100);
    PWM_SetDuty(HT_MCTM0, TM_CH_3, 48000000/80000*57/100);
}
...
void turn_left()
{
    if(ForBack)
    {
        ...
        PWM_SetDuty(HT_MCTM0, TM_CH_3, 48000000/80000*63/100);
    }
    else
    {
...
void turn_right()
{
    if(ForBack)
    {
        PWM_SetDuty(HT_MCTM0, TM_CH_2, 48000000/80000*63/100);
