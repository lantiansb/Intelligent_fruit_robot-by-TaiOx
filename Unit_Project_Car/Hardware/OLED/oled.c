...
void OLED_Init(void)
{
    ...
    GPIO_DirectionConfig(HT_GPIOC, GPIO_PIN_8|GPIO_PIN_5|GPIO_PIN_14|GPIO_PIN_15, GPIO_DIR_OUT);
    GPIO_SetOutBits(HT_GPIOB, GPIO_PIN_4);
    GPIO_SetOutBits(HT_GPIOC, GPIO_PIN_8|GPIO_PIN_5|GPIO_PIN_14|GPIO_PIN_15);
	OLED_RES_Clr();
	delay_ms(200);
	OLED_RES_Set();
